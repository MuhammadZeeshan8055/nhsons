...
<head>
    ...
    <style>
        /* Change Logout text color for screens smaller than 768px */
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-lg">
                    <img src="{{ asset('assets/img/nh_logo.png') }}" alt="NH & Sons Logo"
        ...
        <footer class="main-footer" style="text-align: center;">
          ...
          <strong> Copyright © 2024 NH & Sons ® </strong>  
        </div> --}}
            <!-- Default to the left -->
            <?php $date = date('Y'); ?>
            <strong> Copyright &copy; {{ $date }} NH & Sons ® </strong>
        </footer>
